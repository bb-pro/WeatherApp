...
struct WeatherManager {
    ...
    let weatherURL = "https://api.openweathermap.org/data/2.5/weather?appid=4059f716114043d275715beb933fb929&units=metric&lang=ru"
    ...
    func fetchWeatherWithCoordinate(lat: Double, lon: Double) {
